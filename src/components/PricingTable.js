...
export default function PricingTable() {
  // This line now works perfectly because AuthContext provides 'loading' and 'plan'
  ...
  // It will now correctly wait for the context to be ready.
  if (loading) {
    return (
  ...
  // --- Auth is loaded, we can now safely render ---
  ...
  const allPlans = [
    {
      ...
      cta: <Link href="/register"><Button className="w-full">Get Started</Button></Link>,
